        ...
        <div className="onu-member-filter">
            ...
            <div className="onu-member-checkbox-container">
                <div className="is-member">
                    <input type="checkbox" onChange={checkONUMember} checked={ONUMember} name="onu-member" id="onu-member" />
                    <label htmlFor="onu-member">Member of the United Nations</label>
                </div>
                <div className="is-not-member">
                    <input type="checkbox" onChange={checkIndependent} checked={independent} name="is-not-onu-member" id="is-not-onu-member" />

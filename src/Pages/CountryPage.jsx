...
export const CountryPage = () => {
    ...
    }, [setIsHomePage]); // This effect runs once when the component mounts and unmounts, is used to set the isHomePage state and reset the search input and avoid bugs
